...
<a href="${pageContext.request.contextPath}/search/internal.do?query=busan">SearchController - internal.do</a><br>
<a href="${pageContext.request.contextPath}/search/external.do?query=seoul&p=30">SearchController - external.do</a><br>
